...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT07), 0x00000011u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT11), 0x00000030u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C00), 0x80000017u);

	/* CYDEV_CLK_DIVIDER_A01 Starting address: CYDEV_CLK_DIVIDER_A01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x80000017u);
...
static void AnalogSetDefault(void)
{
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTBM_OA0_SW, 0x00044004u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTBM_OA1_SW, 0x00044002u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x30000000u);

		/* TCPWM_CNT1 Starting address: CYDEV_TCPWM_CNT1_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x000FFF10u);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INTR_SELECT */
		CY_SET_REG32((void *)(CYREG_CPUSS_INTR_SELECT), 0x00000008u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00D89000u);
	CY_SET_REG32((void *)(CYREG_PRT0_INTCFG), 0x00000800u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC2), 0x0000000Fu);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x000000A5u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x00000188u);
	CY_SET_REG32((void *)(CYREG_PRT1_INTCFG), 0x00000008u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC2), 0x000000A1u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x000000D3u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00006010u);
	CY_SET_REG32((void *)(CYREG_PRT2_INTCFG), 0x00000008u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC2), 0x000000C1u);

	/* IOPINS0_3 Starting address: CYDEV_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT3_BASE), 0x00000012u);
