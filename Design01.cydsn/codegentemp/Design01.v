...
module CapSense_CSD_P4_v2_60_12 ;
...
module top ;
    ...
    DieTemp_P4_v1_0_7 DieTemp (
        .temp(Net_688));

    OpAmp_P4_v1_20_8 ADC_2_Buffer (
        .Vminus(Net_2258),
        .Vout(Net_251),
        .Vplus(Net_689));

    OpAmp_P4_v1_20_9 ADC_3_Buffer (
        .Vminus(Net_2259),
        .Vout(Net_252),
        .Vplus(Net_682));
    ...
    CapSense_CSD_P4_v2_60_12 CapSense ();
